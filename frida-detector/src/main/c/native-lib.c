...
void detect_frida_loop(void *pargs) {
    ...
    while (1) {
        __android_log_print(ANDROID_LOG_WARN, APPNAME, "detect_frida_loop");
...
__attribute__((always_inline))
static inline void detect_frida_threads() {
//    __android_log_print(ANDROID_LOG_WARN, APPNAME, "detect_frida_threads");
...
__attribute__((always_inline))
static inline void detect_frida_namedpipe() {
//    __android_log_print(ANDROID_LOG_WARN, APPNAME, "detect_frida_namedpipe");
